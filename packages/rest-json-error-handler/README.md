...
This repository provides versions for the package [communitypackages:rest-json-error-handler](https://github.com/meteor-compat/meteor-rest/tree/devel/packages/rest-json-error-handler) that are compatible with latest Meteor. This is necessary because the author is not maintaining package anymore.

## Changes
- v1.1.3
  - Relaxed `communitypackages:json-routes` dependency to include `v3.0.0`.
